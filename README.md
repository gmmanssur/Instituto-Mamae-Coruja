...
Este projeto foi desenvolvido seguindo práticas esperadas em projetos profissionais:

✔️ HTML semântico e bem estruturado

✔️ Separação de responsabilidades (estrutura, estilo e comportamento)

✔️ Código limpo e legível (Clean Code)

✔️ Organização de arquivos e diretórios

✔️ Responsividade para diferentes dispositivos

✔️ Foco em usabilidade (UX) e experiência do usuário

✔️ Preparação para escalabilidade futura
...
Toda contribuição — técnica, financeira ou institucional — é bem-vinda para fortalecer essa iniciativa.

📄 Licença

Este projeto foi desenvolvido como uma doação ao Instituto Mamãe Coruja. O uso, redistribuição ou adaptação do código deve respeitar os propósitos sociais do projeto.
